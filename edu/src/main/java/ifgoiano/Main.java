...
public class Main {
    public static void main(String[] args) {
        ...
        // Node<Integer> node2 = root;
        // Node<Integer> node3 = new Node<>(root);
        // root.setLeft(null);
        // root.setValue(null);
        // System.out.println("Node2: " + root.getValue());
        // System.out.println("2 Node2: " + node2.getValue());
        // System.out.println("2 Node3: " + node3.getLeft().getValue());

        // Integer[] elements = new Integer[]{15, 14, 16, 13, 17, 12, 18, 11, 19, 10, 20, 1, 2, 100, 80, 90};
        Integer[] elements = new Integer[] {10, 15, 25, 16};
        BinaryTree<Integer> tree2 = new BinaryTree<>();
        Node<Integer> root2 = tree2.createTree(elements);
        // System.out.println(tree2.toString(root2));
        // tree2.remove(root2, 37);
        // System.out.println(tree2.toString(tree2.getRoot()));
        System.out.println(tree2.getFather(root2, 25));
        // System.out.println("Is complete: " + tree2.isComplete(tree2.getRoot()));
